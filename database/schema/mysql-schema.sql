...
CREATE TABLE `historic_import_release_assets` (
  ...
  `record_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `destination_path` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `destination_identity` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `size` bigint unsigned DEFAULT NULL,
  `sha256` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'claimed',
  `create_result` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_receipt` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_version_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verified_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `historic_import_release_attempts` (
  ...
  `historic_import_operation_id` bigint unsigned NOT NULL,
  `authorisation_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `batch_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `authorisation_hash` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `membership_hash` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `state` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'claimed',
  `lease_token` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lease_expires_at` timestamp NOT NULL,
  `failure_summary` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `import_deferred_inbound_emails` (
  ...
  `dispatch_token` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
