...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `crockenhill` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `migrations` VALUES ('2014_02_04_224912_create_sermons_table',1),('2014_10_12_000000_create_users_table',1),('2014_10_12_100000_create_password_resets_table',1),('2015_01_10_180038_create_session_table',1),('2015_02_08_213811_create_pages_table',1),('2015_02_18_210750_create_songs_table',1),('2015_02_18_211526_other_songs_tables',1),('2015_03_03_221128_create_documents_table',1),('2015_06_28_114208_create_meetings_table',1),('2016_02_17_213441_add_fields_to_sessions_table',2),('2016_02_20_163912_add_alternative_title_to_songs_table',2),('2016_03_05_115035_adjust_play_date_table',3),('2016_10_12_074709_update_songs_table',3),('2016_10_15_212903_update_songs',3),('2014_10_12_100000_create_password_reset_tokens_table',4),('2016_12_06_215617_change_recommended_to_current_songs_table',5),('2016_12_06_220437_add_notes_to_songs_table',5),('2016_12_07_212223_change_categories_to_enum_songs_table',5),('2016_12_07_215507_drop_old_categories_songs_table',5),('2017_01_14_230141_add_points_to_songs_table',5),('2017_01_19_232848_add_markdown_to_pages_table',5),('2017_01_28_194118_drop_columns_from_meeting_table',5),('2019_08_19_000000_create_failed_jobs_table',5),('2019_12_14_000001_create_personal_access_tokens_table',5),('2023_11_23_194306_add_navigation_to_pages_table',5);
...
LOCK TABLES `play_date` WRITE;
/*!40000 ALTER TABLE `play_date` DISABLE KEYS */;
/*!40000 ALTER TABLE `play_date` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `scripture_references` WRITE;
/*!40000 ALTER TABLE `scripture_references` DISABLE KEYS */;
/*!40000 ALTER TABLE `scripture_references` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `services` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
  `type` enum('morning','evening') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
