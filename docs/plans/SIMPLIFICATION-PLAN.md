...
Status: **In progress** — five increments landed (two on 2026-06-03, three on 2026-06-04). Remaining hotspots still oversized. Current line counts (2026-06-04, post-increment-5):

| Service | Lines | Public Methods (prior count) |
|---------|------:|---------------:|
| [SermonViewPresenter](../../app/Presenters/SermonViewPresenter.php) | 910 | — |
