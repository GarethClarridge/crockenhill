...
| 4 | **Curate and calibrate video** | **CURATION DONE 2026-08-26; calibration inputs banked, first sermon-analysis draws run and transcript pathology closed 2026-08-27; human truth review remains open.** A transcript-pathology guard, two defects found in it (an outage that destroyed cues, and recovery inheriting the whole-service prompt that made it hallucinate on music), and artifact-level regeneration of four flagged identities all landed 2026-08-27 — see item 6 for the measurements. The completed sermon-analysis arms are unaffected and must not be re-run; the structure inputs were rebuilt as `structure-eval-20260827/manifest.json`. The adjudicated worksheet contains 472 identities / 510 recordings: 470 includes and 2 excludes. Coverage is 290 `full`, 172 `short_partial` and 10 `fragmented` (8 included). Frozen batch `historic-video-full-corpus-20260826`: private manifest `historic-video-curation-manifest-20260826.json`, manifest hash `1ae7e4fc9da6f0cb3db10f167eea86d1d89914a36837a92e23bc05c32ac85298`, derived plan hash `8ecec582659ea18d796ffa50adffeef20cebe1ca529d8bf233c177b9746d29fe`. The bounded sermon-analysis evaluator, banked-input hashes, six review worksheets and structure-manifest skeleton exist. Successful first draws: incumbent Terra/low, 6/6, $0.090694 actual and $7.104363 projected for 470; candidate Luna/low, 6/6, $0.0090454 actual and $0.708556 projected. Both are unscored pending blinded human review. The isolated codec-mismatch fallback was proved from two temporary clips derived from the untouched `2024-12-22-evening` source (H.264/AAC versus VP9/Opus): `historic-video-reencode-proof-20260827.json` records `concat_reencoded`, input/output hashes and zero processing state. | Complete the six human truth worksheets and blinded sermon-output scoring. Only then apply the item 6c gates: repeat Luna/low if its first draw passes; run Luna/none only if Luna/low passes; prepare and run the separately gated structure arms from the banked inputs. Record p50/p95 wall time, failures, retries/rechecks, cost and accepted worker width. Definitive dispatch remains separately authorised. |
