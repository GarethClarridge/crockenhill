...
> genuinely irreducible (the 18-entry accepted-holds draft was reviewed and approved 2026-08-24);
...
|---|---|---|
| Operator: rule on `2024-10-06`'s date mismatch (root cause not yet isolated — see below); `2023-01-01` no longer needs a ruling, it's fixed | — | Final Email/OpenLP RG-A |
| Inspect only repeated/high-volume proposal classes from the combined RG-A run | Operator rules on genuinely irreducible repeated classes | REV-D4 video trigger |
