...
> to 20 the same day — `2024-10-06` and `2016-05-01-pm` — then back to **19**: `2024-10-06` was
> fixed in the resolver, not held, and came back *off* the draft; `2016-05-01-pm` remains and still
> needs operator sign-off, as does the rest of the 19. `oos:generate-corpus-expectation` has been
> re-run against the 19-entry draft: **554 approved sources / 540 identities / 19 accepted holds**);
