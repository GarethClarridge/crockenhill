...
|---|---|---|
| Re-run the combined clean-rehearsal RG-A against the current expectation (554/540/20, up from 554/540/18) and inspect only repeated/high-volume proposal classes it surfaces | Coding agent (rehearsal), then operator rules on genuinely irreducible repeated classes | REV-D4 video trigger |
