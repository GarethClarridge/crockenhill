...
6. **Calibration and model comparison in progress 2026-08-27.** The incumbent pipeline inputs are
   ...
   proves the no-mutation contract. Use the project's configured local Whisper paths for both whole-
