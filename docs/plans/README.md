...
1. **The expanded local Email corpus is re-inventoried, re-curated and approved.** The replacement
   authority accounts for all 533 verbatim and 261 formatted files as 535 manifest entries: 259
   ...
   yields 521 distinct `(date, service)` identities. **Re-curated 2026-08-11 under decision D1**,
   which excludes `2026-06-21-am` in favour of its revised superset: 534 included, 1 excluded, the
   521 identities unchanged. Batch `oos-curated-2026-08-11`; manifest hash `f4b6b833…ee013`; plan
   hash `03d40e46…2de8c1`. (Pre-D1: manifest `928dccb5…823e83`, plan `ebf486c1…18618a`.)
...
| **Re-curate the expanded local Email corpus and approve replacement hashes** | readiness-remediation plan §7.5 and §13.1 | **Completed 2026-08-09; re-curated and re-approved 2026-08-11 under decision D1.** 535 entries — 534 included and 1 excluded (`2026-06-21-am`, superseded in content by its revised superset) — including the three current-era entries; 521 distinct identities, unchanged. Batch `oos-curated-2026-08-11`, manifest `f4b6b833…ee013`, plan `03d40e46…2de8c1`. |
