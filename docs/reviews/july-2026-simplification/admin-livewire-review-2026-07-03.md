...
Prior art checked: the April Livewire-responsibility review (`docs/april-2026-review/livewire-view-responsibility-review-2026-04-16.md`), `docs/archived-plans/SIMPLIFICATION-PLAN.md` (Phases 16–18 already consolidated the upload component once), and `docs/architecture/simplification-backlog.md`.
