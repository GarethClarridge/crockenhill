...
| **SERVICE-DETECTION-IMPROVEMENTS-2026-06-20.md** | June 2026 | Reading-reference resolution (`ResolveReadingReferences`), media-interlude detection (`MediaInterludeCueDetector`), and transition tagging; correctness follow-ups continue in the active `SECTION-EXTRACTION-FINDINGS-REMAINING-2026-06-21.md` |
