    ...
    <div class="relative overflow-hidden">
      ...
      <a href="/christ/sermons/{{$page->slug}}" wire:navigate>
        ...
        <a href="/{{$page->area}}/{{$page->slug}}" wire:navigate>
          @endif
          <img class="w-full rounded-t-lg brightness-75 contrast-75 hover:scale-110 transition-all duration-500" src="{{ $page->heading_image_small_url ?? '/images/headings/small/default.jpg' }}" alt="{{ $page->heading }}" onerror="this.onerror=null;this.src='/images/headings/small/default.jpg';" loading="lazy" width="300" height="169">
