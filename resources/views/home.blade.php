          ...
          <section class="col-md-10 col-lg-8 p-5">
            <div class="white-background">
              ...
              <div class="mb-3 embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/bX8KxMxWktA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
              <div class="text-dark mb-3 text-center">
                  <a class="btn btn-primary btn-lg" href="https://www.youtube.com/watch?v=bX8KxMxWktA" role="button"><i class="fab fa-youtube"></i>&nbsp Watch on YouTube</a>
              </div>
              <br>
              <hr>
              <br>
