...
<form class="" action="/church/members/meetings" method="post">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
      ...
      <input class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
             id="leaders_phone" name="leaders_phone" type="tel" value="{{ old('leaders_phone') }}" maxlength="10">

      <label class="block mt-6" for="leaders_email">Leader's Email</label>
      <input class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
             id="leaders_email" name="leaders_email" type="email" value="{{ old('leaders_email') }}" maxlength="50">
