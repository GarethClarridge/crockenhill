<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="font-display text-3xl">{{ $isEditing ? 'Edit service' : 'Create service' }}</h1>
            <p class="text-gray-600">
                {{ $isEditing ? 'Update the canonical order of service for this date and slot.' : 'Create a service manually when email or OpenLP is not available.' }}
            </p>
        </div>
