...
@section('content')
  <main class="text-center">
    ...
    <div class="px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center max-w-2xl lg:max-w-5xl mx-auto mt-6">
      <x-clickable-card
      ...
      <x-clickable-card
        link="/media/documents/BehaviourPolicy.pdf"
        heading="Positive behaviour policy">
