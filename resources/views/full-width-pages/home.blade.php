...
<link rel="preload" as="image" href="{{ asset('/images/homepage/may2024mobile-800.webp') }}" media="(max-width: 767px)">
@endsection
...
<main id="home" class="text-sm -mt-px">
  ...
  <div class="full-width-head relative py-16 mb-16 md:hidden overflow-hidden">
    ...
    <img
      src="{{ asset('/images/homepage/may2024mobile-800.webp') }}"
      srcset="{{ asset('/images/homepage/may2024mobile-600.webp') }} 600w,
              {{ asset('/images/homepage/may2024mobile-800.webp') }} 800w,
