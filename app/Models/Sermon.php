...
class Sermon extends Model implements Sitemapable
{
    ...
    /**
     * @return Attribute<list<array{id: string, timestamp: float, score: float, plain_path: string, card_path?: string|null, overlay_path?: string|null, composition_mode?: string|null, foreground_extraction_method?: string|null, foreground_bounds?: array<string, int>, foreground_coverage?: float|null}>, never>
     */
    ...
    /**
     * @return Attribute<array{id: string, timestamp: float, score: float, plain_path: string, card_path?: string|null, overlay_path?: string|null, composition_mode?: string|null, foreground_extraction_method?: string|null, foreground_bounds?: array<string, int>, foreground_coverage?: float|null}|null, never>
     */
