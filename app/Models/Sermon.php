...
class Sermon extends Model implements Sitemapable
{
    ...
    public static function validationRules(?self $sermon = null): array
    {
        ...
        return [
            ...
            'segment_start_time' => ['nullable', 'numeric', 'min:0', 'max:2147483647'],
            'segment_end_time' => ['nullable', 'numeric', 'min:0', 'max:2147483647', 'gte:segment_start_time'],
            ...
            'duration' => ['nullable', 'numeric', 'min:0', 'max:2147483647'],
