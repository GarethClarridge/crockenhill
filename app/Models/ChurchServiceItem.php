...
class ChurchServiceItem extends Model
{
    ...
    public static function validationRules(?self $item = null, ?int $churchServiceId = null): array
    {
        return [
            ...
            'church_service_id' => ['required', 'integer', 'min:1', 'max:2147483647', 'exists:church_services,id'],
            ...
            'song_id' => ['nullable', 'integer', 'min:1', 'max:2147483647', 'exists:songs,id'],
            'livestream_processing_id' => ['nullable', 'string', 'max:36'],
            'livestream_service_section_id' => ['nullable', 'integer', 'min:1', 'max:2147483647', 'exists:service_sections,id'],
        ];
    }
