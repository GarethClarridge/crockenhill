...
class UpdateMeetingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'start_time' => ['nullable', 'string', 'max:255', 'date_format:H:i:s,H:i'],
            'end_time' => ['nullable', 'string', 'max:255', 'date_format:H:i:s,H:i', 'after_or_equal:start_time'],
            'leaders_phone' => $modelRules['leaders_phone'],
            'leaders_email' => $modelRules['leaders_email'],
            'meeting_date' => ['nullable', 'string', 'max:255', 'date_format:Y-m-d'],
