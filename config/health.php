...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            // Same admin mailbox the backup notifications (Phase P2) go to.
            'to' => env('HEALTH_TO_ADDRESS', env('LIVESTREAM_ADMIN_EMAIL', '')),
    ...
    /*
     * The route-canaries check is conditionally skipped in local dev (its
     * self-directed HTTP probes would deadlock `artisan serve`); a skipped
