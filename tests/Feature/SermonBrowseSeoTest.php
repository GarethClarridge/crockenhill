...
class SermonBrowseSeoTest extends TestCase
{
    ...
    public function test_unfiltered_archive_renders_presenter_seo_in_the_head(): void
    {
        ...
        $response->assertSee('content="Explore the sermon archive at Crockenhill Baptist Church. Watch or listen to Bible teaching from our Sunday services, filtered by scripture, preacher, or series."', false);
    ...
    public function test_filtered_archive_renders_dynamic_presenter_seo_in_the_head(): void
    {
        ...
        $response->assertSee('name="description"', false);
        $response->assertSee('content="Watch or listen to Bible-based sermons on John 3 from Crockenhill Baptist Church. Explore recent teaching from our morning and evening services."', false);
        $response->assertSee('rel="canonical"', false);
